...
.cloud li {
    list-style: none;
    display: inline; padding-left: 0px; margin-right: 5px; margin-left: 0px;
}
	...
	<div class="col-md-4">
		<div class="padd10_r">
			...
			<div class="nano"><div class="nano-content">
				<ul class="nav_sideX cloud">
				<?php
				$res_cats 	= $dispDt->get_resTypes(); 
				$type_links	= array();
				foreach ($res_cats as $rc => $rc_arr) { 	
					$type_name 	= $rc_arr['download_type'];
					$type_seo 	= $rc_arr['res_type_seo'];
					$type_docs 	= $rc_arr['num_resources'];
					$link = '<li><a href="rescat.php?rsc='.$type_seo.'" title="Resources: '.$type_docs.'">'.$type_name.' </a> </li> ';
					$type_links[] = $link;
				}
