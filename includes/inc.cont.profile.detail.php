...
if($item <> '')
{
	$contArr  		= master::$contMain['full'][$item];	displayArray($contArr);
	$cont_title 	 = $contArr['title'];
	$cont_article   = $contArr['article'];
	
	$cont_extra	 = $contArr['extras'];
	$cont_role	 = @$cont_extra['role'];
	...
	if($cont_role <> '') { $cont_head[] = '<span>Position: <strong>'.$cont_role.'</strong> </span>'; }
	...
	echo '<div class="modal-dialog"> <div class="modal-content"> <div class="modal-header"> <h4 class="modal-title">'.$cont_title.'</h4> </div> <div class="modal-body Xmodal-long nano"><div class="nano-content">';
	?>
	<div>
