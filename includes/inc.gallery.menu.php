...
if($numrows > 0)
{
	...
	foreach ($collection_items as $collection_id) 						
	{
		...
		elseif($pic_type == 'v')
		{
			...
			$item_box  .= '<li><div class="block equalized"><a href="'.$pic_link.'" class="txtgray '.$pic_attr.'" data-id="'.$pic_parent_id.'" title=""><span class="carChopa"><img src="'.$pic_big.'" alt="'.$pic_title.'" class="sshow_big"></span> <span>'.$pic_title.'</span></a><br>&nbsp;</div></li>';
	...
	echo '<div class="wrap_gallery"><ul class="column menu-column column_dashboardX column_halfX">';
	echo $item_box;
	echo '</ul></div>';
