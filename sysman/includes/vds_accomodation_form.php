...
$formname		= "vds_accomodation";
$formact		 = "_add";
$redirect 		= "home.php?d=contents";// . $dir; 
$fData 		   = array();
...
WHERE (`id` = ".quote_smart($id)."); ";
	...
	$rs_fields = mysqli_fetch_fields($rsdata); //mysqli_num_fields($rsdata);
	//displayArray($rs_fields); //exit;
...
<div class="form-group">
<label for="seq">Ordering</label>

<div>	
	<input type="text" name="seq" id="seq" maxlength="4" class="form-control width50" value="<?php echo @$fData['seq']; ?>" />
</div>
</div>
