...
<div class="leftpanelinner ">
		...
		<div class="visible-xs hidden-sm hidden-md hidden-lg">
			<div class="media userlogged">
				<img alt="" src="../image/avatars/avatar_generic.png" class="media-object">
	...
	<ul class="nav nav-pills nav-stacked nav-bracket">
		...
		<ul class="children" > 
			<li ><a href="hforms.php?d=member accounts&op=new"><i class="fa fa-plus-circle"></i> Add New</a></li>
			<li ><a href="home.php?d=member accounts"><i class="fa fa-flag"></i> Manage</a></li>
		</ul>
		</li>
