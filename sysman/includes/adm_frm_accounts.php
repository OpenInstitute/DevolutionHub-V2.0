...
if($op=="edit"){
	...
	$sq_item		= "SELECT * FROM `dhub_reg_account` WHERE  (`account_id`  = ".quote_smart($id).")";	
	...
	$formaction			= "_edit";
		...
		$logoname = ($fData['avatar'] <> '') ? $fData['avatar'] : 'avatar_generic.png'; /*no_image.png*/
...
<input type="hidden" name="redirect" value="home.php?d=<?php echo $dir; ?>" />
	...
	<div class="form-group">
	<label class="textlabel col-md-3" for="group_id">Access Level</label>
	<div class="col-md-3 nopadd">
