...
?>
  ...
  <!--onSubmit="javascript:return valid_menu()"-->
	<form class="admform rwdform rwdfull rwdstripes rwdvalid" name="frm_menus" method="post" action="adm_posts.php" enctype="multipart/form-data" >
    <?php echo $pgtitle; ?>
	  <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center" class="tims">
        ...
        <tr>
          ...
          <td><select name="id_parent1[]" id="id_parent" multiple="multiple" class="form-control multiple">
...
Add Menu Content</label></td>
        ...
        <tr>
         ...
         <!-- onClick="javascript: return valid_menu()" -->
         </td>
          </tr>
      </table>
	</form>	
