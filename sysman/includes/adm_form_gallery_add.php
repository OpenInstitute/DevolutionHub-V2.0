...
<table  border="0" cellspacing="0" cellpadding="0" align="center" width="100%" class="tims" >
	<tr>
		<td style="width:130px;">Parent Menu</td>
		<td><select name="id_parent[]" id="id_parent" multiple="multiple" class="multiple" style="width:600px">
          <?php echo  $dispData->build_MenuSelectRage(0, $parent);
		  //$dispData->build_MenuSelect($dispData->menuMain_portal, $parent, 0 , $parent); ?>
          </select></td>
	</tr>
	<tr>
		<td style="width:100px;">Parent Content</td>
		<td><select name="id_content[]" id="id_content" class="multiple width_full"   style="width:100% !important">
       <?php echo$dispData->build_MenuArticles(master::$contMain['full'], $id_content, 0); ?>
      </select></td>
	</tr>
<?php 
/*	===========================================================
...
<table style="margin:0 "> <tr> <td style="width:40%;padding-left:0;"> <select id="sector_id" name="sector_id" onchange="javascript: show_projects(); "> <?php echo $ddSelect->dropper_select("dhub_app_sector", "sector_id", "title", $sector_id, "Select Sector") ?> </select> </td> <td> <span id="box_project"><input name="project_id" id="project_id" type="text" readonly placeholder="Select Project" ></span></td> </tr> </table>
</td></tr>
<?php 
/*	-----------------------------------------------------------
...
?>	
	...
	<?php /*?><tr>
       ...
       <?php echo $ddSelect->dropper_select("dhub_dt_downloads", "id", "title"); ?>
      </select>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<tr>
		<tr>
		<td style="width:130px;"> <label for="video_name">Youtube Video URL:</label> </td>
		...
		<tr>
		  <td><label for="photo_title">Image Title:</label> </td>
		  <td colspan="3"><input name="photo_title" id="photo_title" type="text" style="width:99%" class="<?php echo $require_pic_title; ?>" value="<?php echo $article_title; ?>" /></td>
		  </tr>
		<tr>
		<td style="width:130px;"> <label for="photo_name">Upload Image: </label> </td>
		<td style="width:270px;"><input type="file" name="myfile" id="photo_name" size="" style="width:100%;"   /></td>
		<td nowrap="nowrap" style="width:150px;text-align:right;"><strong>OR</strong> Enter URL/Name:</td>
	...
	<tr>
		<td nowrap><label for="id_gallery_cat">Gallery Category:</label></td>
			...
			<table class="nopadd nomargin" width="100%" border="0">
	            ...
	            <?php echo $ddSelect->dropper_select("dhub_dt_gallery_category", "id", "title") ?>
	            </select>
				</td>
				<td style="width:150px;text-align:right;"><label>Date: &nbsp;</label></td>
		<td><input type="text" name="date_posted" id="date_posted" value="<?php echo date("m/d/Y"); ?>" class="date-pick half_width required" style="width: ">
				</td>
			</table>	
