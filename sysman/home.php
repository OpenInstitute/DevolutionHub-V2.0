...
<div class="mainpanel ">
			...
			<li>
				<div class="btn-group">
					<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
						<img src="../image/avatars/avatar_generic.png" alt="" /> <?php echo $sys_us_admin['adminname']; ?> <span style="font-size:12px; font-weight:normal; color:#C4CCDF">(<?php echo $sys_us_admin['actype']; ?>)</span>
	...
	<div class="contentpanel ">
		...
		<?php
		//displayArray($_SESSION['sess_dhub_admin']);
