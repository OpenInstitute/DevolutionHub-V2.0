...
if(isset($sys_us_admin['adminname']) and $this_page == 'index.php') 
{ ?> <script language="javascript">location.href="home.php";</script> <?php }
elseif(!isset($sys_us_admin['adminname']) and $this_page <> 'index.php') 
...
<link rel="stylesheet" type="text/css" href="../scripts/datepick/jquery.datepick.css" id="theme">
...
.pgtabsloader { /*position:absolute; top:50px; left:40%;*/ width:100px; height:30px; margin:0 auto; background:url(../image/icons/a-loader.gif) 50% 50% no-repeat;}
